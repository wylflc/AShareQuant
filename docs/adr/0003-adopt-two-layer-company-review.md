# Adopt two-layer company review
...
Consequences: deep reviews must cite company periodic reports, exchange announcements, regulator disclosures, official investor-relations materials, reputable institution reports, or professional research reports. Aggregator company introductions, including Eastmoney-style profile blurbs, may be used only to discover identifiers or business keywords; they must not be relied on as scoring evidence in the deep-review layer.

Considered options: keep iterating fixed weights across all companies; replace all scoring with free-form company memos; or use a two-layer workflow. The two-layer workflow keeps full-market coverage while allowing the final attention decision to reflect company-specific competitive strengths and risks.
